...
public class ColaCine {
	...
	public synchronized String toString() {
		return "ColaCine [ " + this.nombre + " ] " + "Recibidos=" + clientesRecibidos.size() + ", EnCola="
				+ clientesEnCola.size() + ", Atendidos=" + clientesAtendidos.size() + ", SinEntrada="
				+ clientesSinEntrada.size() + ", AsientosRestantes=" + asientosDisponibles;
	}
}
